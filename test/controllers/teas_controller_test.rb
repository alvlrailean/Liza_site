...
class TeasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tea" do
    assert_difference('Tea.count') do
      post teas_url, params: { tea: { color: @tea.color, description: @tea.description, link_to_pic: @tea.link_to_pic, name: @tea.name, price: @tea.price } }
    end
  ...
  test "should update tea" do
    patch tea_url(@tea), params: { tea: { color: @tea.color, description: @tea.description, link_to_pic: @tea.link_to_pic, name: @tea.name, price: @tea.price } }
